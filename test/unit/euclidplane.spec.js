...
describe('Drawing in a Plane', () => {
	...
	it('we can have a horizontal line', () => {
		...
		expect(s1.startX).to.equal(0);
		expect(s1.startY).to.equal(0);
		expect(s1.segments.length).to.equal(1);
		var l1 = s1.segments[0];
